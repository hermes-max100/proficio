...
- **Prompt Studio**: Engineer structured 10/10 master prompts with battle-tested frameworks (CO-STAR, RISEN, etc.), personas, guardrails, and test cases.
- **Auto Engine**: Autonomous pipeline for goal synthesis, custom skill generation, and FastMCP tooling compilation.
